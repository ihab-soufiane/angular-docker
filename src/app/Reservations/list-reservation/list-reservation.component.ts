...
export class ListReservationComponent implements OnInit{
  ...
  delete(id:any,i:number){
    ...
    this.ds.deleteHotel(id).subscribe(response=>{
      console.log(response)
       this.ListReservations.splice(i,1)
 ...
 console.log(hotel);
  ...
  getdata(hotel:string,voiture:string,voyage:string,prix:number,nbreJour:number,total:string,id:any){
    this.messageSuccess=''
    this.dataReservation.hotel=hotel
    this.dataReservation.voiture=voiture
    this.dataReservation.voyage=voyage
    this.dataReservation.prix=prix
    this.dataReservation.nbreJour=nbreJour
    this.dataReservation.total=total
    this.dataReservation.id=id
